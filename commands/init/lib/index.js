...
const { spinnerStart, sleep, execAsync } = require('@cs-cli/utils');
...
class InitCommand extends Command {
  ...
  async downloadTemplate() {
    ...
    // 专门用户缓存项目模板
    const targetPath = path.resolve(userHome, '.cs-cli', 'template');
    const storeDir = path.resolve(userHome, '.cs-cli', 'template', 'node_modules');
      ...
      const projectNamePrompt = {
        ...
        validate: function (v) {
          ...
          setTimeout(function () {
             ...
             */
            if (!isValidateName(v)) {
              done('请输入合法的项目名称，eg: cs-brain-fe');
              return;
            }
